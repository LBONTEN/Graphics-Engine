...
img::Color::Color(std::vector<unsigned int> colorTuple) :
	blue(colorTuple[2]), green(colorTuple[1]), red(colorTuple[2])
{
}
img::Color::Color(std::vector<double> doubleTuple)
{
	red = unsigned( int( doubleTuple[0] * 255));
	green = unsigned( int( doubleTuple[1] * 255));
	blue = unsigned( int( doubleTuple[2] * 255));
}
img::Color::~Color()
{
}
