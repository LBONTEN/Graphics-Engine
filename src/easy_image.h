...
namespace img
{
	...
	class Color
	{
		...
		public:
			...
			/**
			*  \brief Allows an std::vector<unsigned int> to be passed to define a Color
			*
			*  \param colorTuple A vector of length 3 with indices:
			*  	[0] red
			*  	[1] green
			*  	[2] blue
			*/
			Color (std::vector<unsigned int> colorTuple);

			/**
			 *  \brief Allows an std::vector<double> to be passed to define a Color
			 *
			 *  \param doubleTuple A vector of length 3 with indices:
			 *  	[0] red
			 *  	[1] green
			 *  	[2] blue
			 */
			Color (std::vector<double> doubleTuple);
